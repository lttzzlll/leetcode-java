...
| 23 | [Merge k Sorted Lists](https://leetcode.com/problems/merge-k-sorted-lists/discuss/) | [Solution](src/MergekSortedLists) | n*log(n) | O(n) | Divide And Conquer, Recursive, Priority Queue |
| 24 | [Swap Nodes in Pairs](https://leetcode.com/problems/swap-nodes-in-pairs/description/) | [Solution](src/SwapNodesinPairs) | O(n) | O(1) | LinkedList |
| 25 | [Reverse Nodes in k-Group](https://leetcode.com/problems/reverse-nodes-in-k-group/discuss/) | [Solution](src/ReverseNodesink-Group ) | O(n) | O(1) | LinkedList |
...
| 32 | [Longest Valid Parentheses](https://leetcode.com/problems/longest-valid-parentheses/description/) | [Solution](LongestValidParentheses) | O(n) | O(n) | Stack, Dynamic Programming |
...
| 95 | [Unique Binary Search Trees II](https://leetcode.com/problems/unique-binary-search-trees-ii/) | [Solution](src/UniqueBinarySearchTreesII) | O(n^2) | O(n) | Dynamic Programming |
...
| 232 | [Implement Queue using Stacks](https://leetcode.com/problems/implement-queue-using-stacks/description/) | [Solution](src/ImplementQueueusingStacks) | O(n) | O(n) | Stack and Queue |
...
| 235 | [Lowest Common Ancestor of a Binary Search Tree](https://leetcode.com/problems/lowest-common-ancestor-of-a-binary-search-tree/description/) | [Solution](src/LowestCommonAncestorofaBinarySearchTree) | O(log(n)) | O(1) | Binary Search Tree |
...
| 375 | [Guess Number Higher or Lower II](https://leetcode.com/problems/guess-number-higher-or-lower-ii/) | [Solution](src/GuessNumberHigherorLowerII) | O(n^3) | O(n^2) | Dynamic Programming |
| 387 | [First Unique Character in a String](https://leetcode.com/problems/first-unique-character-in-a-string/description/) | [Solution](src/FirstUniqueCharacterinaString) | --- | --- | HashMap, Iteration, Count |
...
| 404 | [Sum of Left Leaves](https://leetcode.com/problems/sum-of-left-leaves/description/) | [Solution](src/SumofLeftLeaves) | O(n) | O(1) | Binary Tree, Iteration |
...
| 414 | [Third Maximum Number](https://leetcode.com/problems/third-maximum-number/description/) | [Solution](/src/ThirdMaximumNumber) | O(n) | O(1) | Compare |
| 437 | [Path Sum III](https://leetcode.com/problems/path-sum-iii/description/) | [Solution](src/PathSumIII) | O(n) | O(1) | Binary Tree, DFS |
| 441 | [Arranging Coins](https://leetcode.com/problems/arranging-coins/) | [Solution](src/ArrangingCoins) | | --- | --- | Number |
